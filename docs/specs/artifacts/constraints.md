...
| Constraint | Source |
|---|---|
| **Fully local, zero cloud.** The entire stack runs under Docker Compose on one machine; no cloud account or external managed service is required. | [high-level-idea.md](../design/high-level-idea.md), [08-spec-platform-operations.md](../design/platform/08-spec-platform-operations.md#2-deployment) |
