...
| Introducing the crop → targets mapping | Still **owned by Phase 2** ([P2 crop profiles](./platform/spec-platform-crop-profiles.md)); Phase 4 plans only **within** the crop-safe bounds |
